...
export const HELP_USAGE_LINES: string[] = [
  'claw-browser --tab-id <tab-id> <command> [...]  # Most commands require tab binding',
  'claw-browser --session <name> <command> [...]   # Use session via flag',
  'claw-browser tab new [url]                      # Create a new tab (no --tab-id required)',
...
export const HELP_EXAMPLES = {
  direct: [
    'claw-browser --tab-id <tab-id> open https://example.com',
    'claw-browser --tab-id <tab-id> click "button[type=\'submit\']"',
    'claw-browser --tab-id <tab-id> press Enter',
    'claw-browser --tab-id <tab-id> scroll down 600',
    'claw-browser --tab-id <tab-id> scrollintoview "#submit"',
    'claw-browser --tab-id <tab-id> mouse move 300 220',
    'claw-browser --tab-id <tab-id> snapshot',
    'claw-browser --tab-id <tab-id> eval "location.href"',
    'claw-browser --tab-id <tab-id> snapshot -i -u',
    'claw-browser --tab-id <tab-id> snapshot -s "#main" -d 4',
    'claw-browser --tab-id <tab-id> set media dark',
    'claw-browser --tab-id <tab-id> set timezone Asia/Shanghai',
    'claw-browser --tab-id <tab-id> set locale zh-CN',
    'claw-browser --tab-id <tab-id> set geo 31.2304 121.4737',
    'claw-browser --tab-id <tab-id> set content "<h1>Hello</h1>"',
    'claw-browser --tab-id <tab-id> find text "Sign in" click',
    'claw-browser --tab-id <tab-id> network requests --method GET',
    'claw-browser --tab-id <tab-id> dialog status',
  ...
  session: [
    ...
    'claw-browser --session my-session --tab-id <tab-id> navigate https://example.com',
    'claw-browser --session my-session --tab-id <tab-id> click "button[type=\'submit\']"',
    'claw-browser --session my-session --tab-id <tab-id> snapshot',
